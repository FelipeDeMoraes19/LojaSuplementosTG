                ...
                switch (opcao) {
                    case 1:
                        ...
                        if (produtos.isEmpty()) {
                            ...
                            if (produtoEscolhido < 1 || produtoEscolhido > produtos.size()) {
                        ...
                        BioTipo.BiotipoInfo biotipoInfo = BioTipo.getBiotipo(imc); 
                        System.out.println("Seu biotipo é: " + biotipoInfo.getDescricao());
                        System.out.println("Suplementos recomendados para o seu biotipo:");
                        for (String suplemento : biotipoInfo.getSuplementosRecomendados()) {
